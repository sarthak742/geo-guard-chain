...
import { Users, AlertTriangle, MapPin, Activity, Clock, CheckCircle, Eye } from "lucide-react";
  ...
  return (
    <div className="p-4 space-y-6 max-w-7xl mx-auto">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold">Admin Operations Center</h1>
          <p className="text-muted-foreground">Real-time incident monitoring & response</p>
        </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card className="p-6">
          <h3 className="text-lg font-semibold mb-4">Incident Analytics</h3>
          <div className="space-y-3">
            <div className="flex justify-between items-center">
              <span className="text-sm">Theft Incidents</span>
              <div className="flex items-center gap-2">
                <div className="w-20 h-2 bg-muted rounded-full">
                  <div className="w-3/5 h-full bg-restricted rounded-full"></div>
                </div>
            ...
            <div className="flex justify-between items-center">
              ...
              <div className="flex items-center gap-2">
                <div className="w-20 h-2 bg-muted rounded-full">
                  <div className="w-1/4 h-full bg-caution rounded-full"></div>
                </div>
                <span className="text-sm font-medium">25%</span>
              </div>
            </div>
            <div className="flex justify-between items-center">
              <span className="text-sm">Lost Tourists</span>
              <div className="flex items-center gap-2">
                <div className="w-20 h-2 bg-muted rounded-full">
                  <div className="w-1/6 h-full bg-safe rounded-full"></div>
                </div>
